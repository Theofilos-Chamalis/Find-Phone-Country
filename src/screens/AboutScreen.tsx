...
export default () => {
  const onSendEmail = () => {
    Linking.openURL('mailto:theofxam@gmail.com?cc=&subject=Find Phone Country&body=').catch(() => {
      Alert.alert(
        'Error',
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../../assets/globenphone.png')} style={styles.image} />
      <View style={styles.textGroup}>
        ...
        <Text textBreakStrategy="balanced" style={styles.textParagraph}>
          This app was created by Theofilos Chamalis. For any questions, suggestions or donations
          feel free to contact me at:
        </Text>
        <Text style={styles.emailText} onPress={onSendEmail}>
          theofxam@gmail.com
        </Text>
      </View>
    </View>

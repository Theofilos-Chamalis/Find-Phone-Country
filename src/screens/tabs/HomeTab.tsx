...
export default class HomeTab extends PureComponent<{}, homeTabState> {
  ...
  onSubmitFormNumber = () => {
    if (this?.state?.phone && this.state.phone.length > 5) {
      ...
      Alert.alert('Error', 'Please enter a valid phone number with the appropriate country code!');
    }
  };
    ...
    return (
      <View style={styles.formStyle}>
        <TextInput
          ...
          onChangeText={enteredNumber => this.onChangeFormNumber(enteredNumber)}
    ...
    return (
      <SafeAreaView style={styles.containerStyle}>
        ...
        <ScrollView
          ...
          {this.showImage ? (
            <Image source={require('../../../assets/globenphone.png')} style={styles.imageStyle} />
          ) : null}
          <View
            style={
              this.showImage
                ? styles.inputAndTextContainer
                : styles.inputAndTextContainerWithKeyboard
            }>
